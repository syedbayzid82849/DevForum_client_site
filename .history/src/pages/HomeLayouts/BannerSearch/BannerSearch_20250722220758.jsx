...
const BannerSearch = ({ setSearchResult, setSearchLoading, setSearchError }) => {
    ...
    // এই useEffect গুলো এখন ঠিকভাবে কাজ করবে কারণ HeroSection থেকে আসা ফাংশন রেফারেন্স স্থিতিশীল।
    useEffect(() => {
        setSearchResult(searchData);
    }, [searchData, setSearchResult]); // setSearchResult এখানে থাকলে এখন আর সমস্যা করবে না

    useEffect(() => {
        setSearchLoading(isSearchLoading);
    }, [isSearchLoading, setSearchLoading]); // setSearchLoading এখানে থাকলেও সমস্যা করবে না

    useEffect(() => {
        setSearchError(isSearchError);
    }, [isSearchError, setSearchError]); // setSearchError এখানে থাকলেও সমস্যা করবে না

        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex justify-center mb-6 gap-4">
                <button
                    ...
                    className={`px-4 py-2 rounded border transition-all duration-150 ${sortBy === "newest"
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded border transition-all duration-150 ${sortBy === "popular"
                        ? "bg-blue-600 text-white"
                        : "bg-white text-blue-600 border-blue-600"
                        }`}
                >

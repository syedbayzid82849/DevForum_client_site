...
const AnnouncementSection = () => {
    ...
    return (
        <div id='announcement' className="bg- border border-yellow-300 p-4 rounded-lg shadow-md mt-6">
            <div className="flex items-center mb-2">
                <FaBullhorn className="text-yellow-600 mr-2" />
                <h2 className="text-xl font-semibold te`xt-yellow-800">Announcements</h2>
            </div>

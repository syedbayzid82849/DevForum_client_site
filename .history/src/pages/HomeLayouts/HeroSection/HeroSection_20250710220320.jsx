...
const HeroSection = () => {
    return (
        ...
        >
            <h1 className="text-4xl font-bold text-">Welcome to the Pet Management Platform</h1>
            <p className="text-lg text-gray-700">Manage and explore pets easily with us</p>

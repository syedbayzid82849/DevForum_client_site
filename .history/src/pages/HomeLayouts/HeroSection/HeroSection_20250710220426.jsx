...
const HeroSection = () => {
    return (
        ...
        >
            <h1 className="text-4xl font-bold text-white">Welcome to the Pet Management Platform</h1>
            <p className="text-lg text-white">Manage and explore pets easily with us</p>

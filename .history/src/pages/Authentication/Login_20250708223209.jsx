        ...
        <div className="flex flex-col max-w-md mx-auto items-center p-6 rounded-md sm:p-10 ">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-12 w-full">
                ...
                <div className="space-y-2">
                    <div>
                        <button type="submit" className="w-full px-8 py-3 font-semibold rounded-4xl mb-4 bg-amber-50 text-black ">
                            Login
                        </button>
                    </div>
                    <p className="px-6 text-sm text-center text-amber-50 ">Don't have an account yet?
                        <NavLink to="/register"><span className="hover:underline text-amber-50"> Sign up</span></NavLink>
                    </p>
                </div>
            </form>
        </div>

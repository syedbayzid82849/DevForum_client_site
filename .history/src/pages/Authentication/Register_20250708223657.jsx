...
const Register = () => {
    ...
    const onSubmit = (data) => {
        ...
        // data.name, data.email, data.password এখানে পাবে
    };
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 border rounded-md border-gray-300 800"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 border rounded-md border-gray-300 dark:bg-gray-50 dark:text-gray-800"

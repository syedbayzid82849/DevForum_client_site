...
import { useForm, Controller } from "react-hook-form"; // Controller ইম্পোর্ট করুন
...
import toast from 'react-hot-toast'; // Toaster for messages
...
const AddPost = () => {
    ...
    const { data, isPending, refetch } = useQuery({ // refetch যোগ করা হলো পোস্ট করার পর আপডেট করার জন্য
        queryKey: ['postCount', user?.email],
        queryFn: async () => {
            // নিশ্চিত করুন URL টি সঠিক এবং আপনার সার্ভারে এই এন্ডপয়েন্ট আছে

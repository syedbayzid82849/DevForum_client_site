...
const AddPost = () => {
    ...
    const { data, isPending, refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await useAxiosSecure.get(`/posts/count?email=${user.email}`);
            return res.data;
        },
        enabled: !!user?.email,
    });
    ...
    const onSubmit = async (formData) => {
        ...
        try {
            await .post("http://localhost:3000/posts", post);
                    ...
                    <div className="form-control text-center">
                        ...
                        <div className="avatar">
                            <div className="w-24 rounded-full mx-auto ring ring-primary ring-offset-base-100 ring-offset-2">
                                <img src={currentUser?.photoURL || userDefault} alt="Author Avatar" />
                            </div>
                        </div>
                    </div>

...
const AddPost = () => {
    ...
    if (data && data.count >= 5) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] p-">
                <div className="card w-full max-w-lg bg-base-100 shadow-xl p- text-center">

...
const UserDashboard = () => {
    ...
    if (isError) return <p className="text-center py-10 text-red-500">Error fetching dashboard data.</p>;
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-4 bg-white dark:bg-gray-800 p-5 rounded-2xl shadow">
                ...
                <div>
                    ...
                    <span
                        className={`px-3 py-1 rounded-full text-sm font-semibold ${membership === "Gold"
                        ...
                        {recentPosts.map((post) => (
                            ...
                            >
                                ...
                                <div className="flex justify-between text-sm text-gray-600 dark:text-gray-500">
                                    <span>Comments: {Array.isArray(post.commentCount) ? post.commentCount.length : 0}</span>
                                    <span>Upvotes: {Array.isArray(post.upVote) ? post.upVote.length : 0}</span>
                                    <span>Downvotes: {Array.isArray(post.downVote) ? post.downVote.length : 0}</span>
                                </div>

                        ...
                        {recentPosts.map((post) => (
                            ...
                            >
                                ...
                                <div className="flex justify-between text-sm text-gray-600 dark:text-gray-500">
                                    <span>
                                        Comments: {Array.isArray(post.commentCount) ? post.commentCount.length : 0}
                                    </span>
                                    <span>
                                        Upvotes: {Array.isArray(post.upVote) ? post.upVote.length : 0}
                                    </span>
                                    <span>
                                        Downvotes: {Array.isArray(post.downVote) ? post.downVote.length : 0}
                                    </span>
                                </div>

    ...
    return (
      ...
      {recentPosts.length > 0 ? (
        recentPosts.map((post) => (
          <div
            key={post._id}
            className="flex flex-col space-y-4 p-4 border rounded-xl shadow-sm bg-white dark:bg-gray-800"
          >
            {/* Author info */}
            <div className="flex items-center space-x-4">
              <img
                src={post.authorPhoto || "https://source.unsplash.com/100x100/?portrait"}
                alt={post.authorName}
            ...
            <div>
              ...
              <p className="text-sm dark:text-gray-600">{post.content}</p>
            </div>

            {/* Post actions */}
            <div className="flex justify-between items-center text-sm dark:text-gray-600">

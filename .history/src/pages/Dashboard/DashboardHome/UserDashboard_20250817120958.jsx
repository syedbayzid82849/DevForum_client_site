    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div className="bg-blue-100 dark: p-4 rounded-xl shadow text-center">
                    <h3 className="text-lg font-bold">Posts</h3>
                    <p className="text-2xl">{totalPosts}</p>
                </div>
                <div className="bg-green-100 dark: p-4 rounded-xl shadow text-center">
                    <h3 className="text-lg font-bold">Comments</h3>
                    <p className="text-2xl">{totalComments}</p>
                </div>
                <div className="bg-purple-100 dark: p-4 rounded-xl shadow text-center">
                    <h3 className="text-lg font-bold">Upvotes</h3>
                    <p className="text-2xl">{totalUpvotes}</p>
                </div>
                <div className="bg-red-100 dark: p-4 rounded-xl shadow text-center">
                    <h3 className="text-lg font-bold">Downvotes</h3>
                    <p className="text-2xl">{totalDownvotes}</p>
                </div>
                <div className="bg-yellow-100 dark: p-4 rounded-xl shadow text-center">

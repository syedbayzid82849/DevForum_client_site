...
const MakeAnnouncement = () => {
    ...
    return (
        <div className="w-[80%] h-full flex justify-center items-center p-6  shadow-md rounded-lg">
            <h2 className="text-2xl font-bold mb-4 text-center text-gray-700">📢 Make an Announcement</h2>

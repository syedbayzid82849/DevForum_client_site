                ...
                <table className="w-full border border-gray-300">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="p-2 border te">Comment ID</th>
                            <th className="p-2 border te">Feedback</th>
                            <th className="p-2 border te">Reporter</th>
                            <th className="p-2 border te">Actions</th>
                        </tr>
                    </thead>
                    <tbody>

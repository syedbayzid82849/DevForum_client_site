                ...
                <table className="w-full border border-gray-300">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="p-2 border text">Comment ID</th>
                            <th className="p-2 border text">Feedback</th>
                            <th className="p-2 border text">Reporter</th>
                            <th className="p-2 border text">Actions</th>
                        </tr>
                    </thead>
                    <tbody>

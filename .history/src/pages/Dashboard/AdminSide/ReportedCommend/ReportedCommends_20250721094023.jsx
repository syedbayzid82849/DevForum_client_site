            ...
            {reports.length === 0 ? (
                ...
                <table className="w-full border border-gray-300">
                    <thead className="bg-gray-100">
                        <tr>
                            <th className="p-2 border textb">#</th>
                            <th className="p-2 border textb">Comment ID</th>
                            <th className="p-2 border textb">Feedback</th>
                            <th className="p-2 border textb">Reporter</th>
                            <th className="p-2 border textb">Actions</th>
                        </tr>
                    </thead>
                    <tbody>

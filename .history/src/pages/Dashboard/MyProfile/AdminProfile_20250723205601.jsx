...
const AdminProfile = () => {
    ...
    return (
        <div className="p-4 space-y-6 w-[95%] md:max-w-7xl mx-auto">
            <h2 className="text-2xl font-bold">Admin Profile</h2>
            <UserProfile></UserProfile>

            <div>
                <h3 className="text-xl font-bold mb-2 text-center">Admin Stats</h3>
            ...
            <div className="mt-10">
                <h3 className="text-xl font-bold mb-2 text-center">Add New Tag</h3>

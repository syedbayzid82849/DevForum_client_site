...
<div className="w-full bg-base-100 p-2 flex justify-center lg:hidden">
    <Link
        to="/"
...
{/* For large screens, inside drawer above menu */}
<Link
    to="/"
    className="hidden lg:flex justify-center items-center mb-4 btn btn-outline btn-primary"
>
    Back to Home
</Link>

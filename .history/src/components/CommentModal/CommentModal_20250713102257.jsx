...
const CommentModal = ({ postId, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-transparent flex justify-center items-center z-50">
            <div className="bg-gray-800 p-6 rounded-lg w-full max-w-md">
                ...
                <div className="flex justify-end gap-2">
                    <button onClick={onClose} className="px-4 py-1 bg-gray-400 rounded ">Close</button>
                    <button onClick={handleSubmit} className="px-4 py-1 bg-blue-600 rounded text-whit">Post</button>
                </div>
            </div>
        </div>
    );

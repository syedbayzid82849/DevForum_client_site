...
const PostCard = ({ post }) => {
    return (
        <div className="md:w-3/5 mx-auto border rounded-xl p-4 bg-white shadow-md mb-4">
            {/* Author Info */}
            ...
            <div>
                ...
                <p className="text-gray-600 mt-1">{post.fhhusdfxzcvddfgfgsxzdsfcvfxcdfains82846455453446534rt54369@gmail.com}</p>
            </div>

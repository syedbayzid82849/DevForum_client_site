...
const PostCard = ({ post }) => {
    return (
        <div className="w-3/5 mx-auto border rounded-xl p-4 bg-white shadow-md space-y-2">
            ...
            {/* Title */}
            <div> <h3 className="text-xl font-bold mt-2">{post.title}</h3></div>

            <div>
                <img src={{post.}'https://i.ibb.co/W4Yjw790/default-image.png'} alt={post.title} className="w-full h-48 object-cover rounded-md" />
            </div>

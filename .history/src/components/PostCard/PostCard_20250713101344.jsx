    ...
    return (
        <div className="max-w-3xl w-full mx-auto border rounded-xl p-4 bg-white shadow-md mb-4">
            ...
            <div className="flex justify-around p-2 overflow-auto">
                ...
                <button 
                onClick={() => setShowModal(true)} className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 flex-grow justify-center transition-colors duration-200">

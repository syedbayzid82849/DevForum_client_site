...
import { DotsHorizontalIcon, ThumbUpIcon, ChatAltIcon, ShareIcon } from '@heroicons/react/outline'; // Heroicons থেকে আইকন ইম্পোর্ট করুন

const FacebookPostCard = ({ post }) => { // ⭐️ এখানে পরিবর্তন: এখন পুরো 'post' অবজেক্টটি prop হিসেবে আসছে
    const {
        authorImage,
        authorName,
        // authorEmail, // আপনার কার্ডে প্রয়োজন নেই, কিন্তু ডেটার অংশ
        title,
        description,
        // tags, // আপনার কার্ডে প্রয়োজন নেই
        upVote,
        downVote,
        createdAt
    } = post;

    // createdAt থেকে সময় 'time ago' স্ট্রিং এ পরিবর্তন
    const formatTimeAgo = (isoDate) => {
        ...
        return date.toLocaleDateString(); // If older than a month, show full date
    };

    const timeAgoString = formatTimeAgo(createdAt);

    // লাইক এবং কমেন্টের জন্য ডামি ডেটা বা প্রকৃত ডেটা ব্যবহার করতে পারেন
    const likesCount = upVote ? upVote.length : 0; // upVote array এর দৈর্ঘ্য
    const commentsCount = 37; // আপনার JSON এ কমেন্টের সংখ্যা নেই, তাই এটি ডামি
    ...
    return (
        <div className="bg-white rounded-lg shadow-md max-w-xl mx-auto my-6 overflow-hidden">
            ...
            <div className="flex items-center p-4">
                <img
                    src={authorImage || 'https://i.ibb.co/CByG1gV/user-avatar.png'} // ডিফল্ট ছবি

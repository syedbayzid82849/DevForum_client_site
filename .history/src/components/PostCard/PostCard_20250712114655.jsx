...
const PostCard = ({ post }) => {
    return (
        <div className="max-w-3xl w-full mx-auto border rounded-xl p-4 bg-white shadow-md mb-4">
            ...
            {/* Title */}
            <div>
                <h3 className="text-xl font-bold mt-2 text-gray-600 mt-1 break-words whitespace-pre-line">{post.title}</h3>
                <p className="text-gray-600 mt-1 text-gray-600 mt-1 break-words whitespace-pre-line">{post.description}</p>
            </div>

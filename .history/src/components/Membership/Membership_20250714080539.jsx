...
const Membership = () => {
    return (
        <div class="mx-auto">
            ...
            <div class="mt-5 p container mx-auto space-y-12 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8">
                <div class="relative px-7  border border-gray-200 rounded-2xl shadow-sm flex flex-col">
                    <div class="flex-1">
                        ...
                        <ul role="list" class="mt-6 space-y-6">
                            ...
                            </svg><span class="ml-3 ">Hightst can 5 posts </span></li>
                            <li class="flex"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="flex-shrink-0 w-6 h-6 text-emerald-500" aria-hidden="true">
                                <polyline points="20 6 9 17 4 12"></polyline>

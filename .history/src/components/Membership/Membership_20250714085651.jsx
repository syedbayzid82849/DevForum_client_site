        ...
        <div class="mx-auto">
            ...
            <div class="mt-5 p-7 container mx-auto space-y-12 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-x-8">
                <div class="relative p-8  border border-gray-200 rounded-2xl shadow-sm flex justify-end flex-col">
                    ...
                    <button
                    onClick={()=>handleSignup for free}
                        type="button"
                        class="bg-emerald-50 text-emerald-700 hover:bg-emerald-100 w-full py-3 px-6 border border-transparent rounded-md text-center font-medium"

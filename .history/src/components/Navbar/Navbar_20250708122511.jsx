        ...
        <div className="bg-base-100 w-full shadow-bottom-md border">
            <div className="navbar mx-auto ">
                ...
                <div className="navbar-start">
                    ...
                    <Link to="/" className="text-2xl font-bold ml-2 flex flex-col">
                        <span className="text-primary"><span><img className="w-8 h-8" src="/src/assets/logo.png" alt="" /></span>PetMate</span>
                    </Link>
                </div>

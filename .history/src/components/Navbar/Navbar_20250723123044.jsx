        ...
        <>
            <li>
                <NavLink
                    to="/"
                    className={({ isActive }) =>
                        isActive ? "text-primary font-bold underline" : "font-medium"
                    }
                >
                    Home
                </NavLink>
            ...
            <li>
                <NavLink
                    to="/membership"
                    className={({ isActive }) =>
                        isActive ? "text-primary border shadow-2xl" : "font-medium"
                    }
                >
                    Membership
                </NavLink>
            ...
            {user && (
                <li>
                    <NavLink
                        to="/dashboard"
                        className={({ isActive }) =>
                            isActive ? "text-primary font-bold underline flex items-center gap-1" : "font-medium flex items-center gap-1"
                        }
                    >
                        <MdDashboard />
                        Dashboard

        ...
        <>
            ...
            <li>
                <NavLink
                    to="/membership"
                    className={({ isActive }) =>
                        isActive ? "text-primary font-bold border-b-2" : "font-medium"
                    }
                >
                    Membership
                </NavLink>
            ...
            {user && (
                <li>
                    <NavLink
                        to="/dashboard"
                        className={({ isActive }) =>
                            isActive ? "text-primary font-bold border flex items-center gap-1" : "font-medium flex items-center gap-1"
                        }
                    >
                        <MdDashboard />
                        Dashboard

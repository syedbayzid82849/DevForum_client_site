        ...
        <>
            <li>
                <NavLink
                    to="/"
                    className={({ isActive }) =>
                        isActive ? "text-primary font-bold border-primary" : "font-medium"
                    }
                >
                    Home
                </NavLink>
            ...
            {user && (
                <li>
                    <NavLink
                        to="/dashboard"
                        className={({ isActive }) =>
                            isActive ? "text-primary font-bold border-primary flex items-center gap-1" : "font-medium flex items-center gap-1"
                        }
                    >
                        <MdDashboard />
                        Dashboard
                            ...
                            <div className="dropdown dropdown-end">
                                <div tabIndex={0} className="btn btn-circle avatar online">
                                    <img
                                        ...
                                        alt="Profile"
                                        className="rounded-full w-12 border-primary"
                                    />
                                </div>
                                <ul
                                    tabIndex={0}
                                    className="mt-3 z-[50] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-72 h-72 overflow-y-auto space-y-3"
                                >
                                    <li>
